...
Route::group(['middleware' => ['admin']], function () {
    ...
    Route::get('/edit-published-recruitment/{id}', ['uses' => 'RecruitmentController@putPublishedRecruitment'])->name('editpublishedrecruitment')->middleware('recruiter', 'auth', 'admin');

    Route::delete('/delete-recruitment/{id}', 'RecruitmentController@deleteRecruitment')->name('deleterecruitment')->middleware('auth', 'admin');
    ...
    // Route::put('/edit-ongoing-recruitment/{id}', ['uses' => 'RecruitmentController@putOngoingRecruitment'])->name('editongoingrecruitment')->middleware('recruiter', 'auth', 'admin');
    ...
    // Route::put('/edit-concluded-recruitment/{id}', ['uses' => 'RecruitmentController@putConcludedRecruitment'])->name('editconcludedrecruitment')->middleware('recruiter', 'auth', 'admin');

    // Route::any('/delete-concluded-recruitment/{id}', 'RecruitmentController@deleteConcludedRecruitment')->name('deleteconcludedrecruitment')->middleware('auth', 'admin', 'recruiter');
    ...
    Route::get('/start-recruitment', 'RecruitmentController@startRecruitment')->name('startrecruitment')->middleware('recruiter', 'auth', 'admin');
